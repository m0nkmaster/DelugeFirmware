...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_REVERSE_STUTTER, "Reverse Stutter Rate"},
        {STRING_FOR_DEFAULT_AUTOMATION, "Automation"},
		{STRING_FOR_COMMUNITY_FEATURE_TRIM_FROM_START_OF_AUDIO_CLIP, "Trim from start of audio clip"},
        ...
        {STRING_FOR_ARP_NOTE_PROBABILITY_MENU_TITLE, "Arp note prob"},
        ...
        {STRING_FOR_CONFIGURE_EXPORT_STEMS_MASTER_ARRANGEMENT, "Export Master Arrangement"},
